...
- User stats (streak, daysTracked, entryCount) are calculated **on-demand** when user clicks share.
- Stats are computed from full entry history, ensuring accurate current streak.
